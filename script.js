document.addEventListener('DOMContentLoaded', () => {
    ...
    const chineseNewYear = new Date(new Date().getFullYear() + 1, 1, 10); // Set to approximate date of Chinese New Year
    ...
    function updateTime() {
        ...
        eventDateEl.innerHTML = `<i class="fas fa-calendar"></i> Chinese New Year Date: ${chineseNewYear.toLocaleDateString()}`;
        eventDayEl.innerHTML = `<i class="fas fa-calendar-day"></i> Chinese New Year Day: ${chineseNewYear.toLocaleDateString(undefined, { weekday: 'long' })}`;

        const timeLeft = chineseNewYear - now;
        ...
        countdownEl.innerHTML = `<i class="fas fa-hourglass-half"></i> Time left for Chinese New Year: ${monthsLeft}m ${daysLeft}d ${hoursLeft}h ${minutesLeft}m ${secondsLeft}s`;
